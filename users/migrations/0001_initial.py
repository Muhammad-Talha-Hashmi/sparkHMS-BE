# Generated by Django 5.0.6 on 2024-08-01 12:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_saml', models.BooleanField(default=False)),
                ('auth0_connection_name', models.CharField(blank=True, max_length=60, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='organization_created_by', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='user',
            name='organization',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_organization_fk', to='users.organization'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_datetime', models.DateTimeField(auto_now_add=True, null=True)),
                ('created_date', models.DateField(auto_now_add=True, null=True)),
                ('organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='credentials_organization_fk', to='users.organization')),
            ],
            options={
                'db_table': 'organization_credential',
            },
        ),
        migrations.CreateModel(
